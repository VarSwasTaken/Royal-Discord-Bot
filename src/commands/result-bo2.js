...
const result_bo2 = async (interaction) => {
    ...
    const winner_logo = functions.resizeImage(await loadImage(interaction.options.get('first-team-logo').attachment.url), 1523);
    const loser_logo = functions.resizeImage(await loadImage(interaction.options.get('second-team-logo').attachment.url), 1523);
